<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="image_url" class="form-control @error('image_url') is-invalid @enderror" value="{{ old('image_url', $product?->image_url) }}" id="image_url" placeholder="Image Url">
            {!! $errors->first('image_url', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="device_os_description" class="form-label">{{ __('Device Os Description') }}</label>
            <input type="text" name="device_os_description" class="form-control @error('device_os_description') is-invalid @enderror" value="{{ old('device_os_description', $product?->device_os_description) }}" id="device_os_description" placeholder="Device Os Description">
            {!! $errors->first('device_os_description', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
